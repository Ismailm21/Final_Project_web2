...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/06-11-2024/shipper-liberty-demo_Free/1152162366/web/elements.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 May 2025 18:06:58 GMT -->
  ...
  <div class="breadcrumb-bg w3l-inner-page-breadcrumb py-5">
    <div class="container pt-lg-5 pt-md-3 p-lg-4 my-lg-3">
      <ul class="breadcrumbs-custom-path pt-5 mt-3 text-center">
        ...
        <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span> Components</li>
      </ul>
    </div>
  </div>
  <!--//breadcrumb-bg-->
  ...
  <section class="bootstrap-components page-blogw3 py-5">
    <div class="container pt-lg-4 pb-lg-5">
      <div class="title-content text-center">
        <h6 class="title-subhny mb-2">Bootstrap Version 4.0</h6>
        <h3 class="title-w3l mb-5">Bootstrap Components</h3>
      </div>
      ...
      <div class="pb-lg-5 typo-wthree">
        ...
        <!-- //Outline buttons code -->
         ...
         <div class="components mt-5">
          ...
          <div class="components-info">
            <div class="card-deck">
              <div class="card">
                <img src="assets/images/g1.jpg" class="card-img-top img-fluid" alt="Card image cap">
              ...
              <div class="card">
                <img src="assets/images/g2.jpg" class="card-img-top img-fluid" alt="Card image cap">
                <div class="card-body">
                  <h5 class="card-title">Card title</h5>
              ...
              <div class="card">
                <img src="assets/images/g3.jpg" class="card-img-top img-fluid" alt="Card image cap">
                <div class="card-body">
                  <h5 class="card-title">Card title</h5>
        ...
        <div class="code">
          <pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"card-deck"</span><span class="nt">&gt;</span>
            ...
            <span class="nt">&lt;/div&gt;</span>
            <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"card"</span><span class="nt">&gt;</span>
              <span class="nt">&lt;img</span> <span class="na">class=</span><span class="s">"card-img-top"</span> <span class="na">src=</span><span class="s">"assets/images/g2.jpg"</span> <span class="na">alt=</span><span class="s">"Card image cap"</span><span class="nt">&gt;</span>
              <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"card-body"</span><span class="nt">&gt;</span>
                <span class="nt">&lt;h5</span> <span class="na">class=</span><span class="s">"card-title"</span><span class="nt">&gt;</span>Card title<span class="nt">&lt;/h5&gt;</span>
            ...
            <span class="nt">&lt;/div&gt;</span>
            <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"card"</span><span class="nt">&gt;</span>
              <span class="nt">&lt;img</span> <span class="na">class=</span><span class="s">"card-img-top"</span> <span class="na">src=</span><span class="s">"assets/images/g3.jpg"</span> <span class="na">alt=</span><span class="s">"Card image cap"</span><span class="nt">&gt;</span>
              <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"card-body"</span><span class="nt">&gt;</span>
                <span class="nt">&lt;h5</span> <span class="na">class=</span><span class="s">"card-title"</span><span class="nt">&gt;</span>Card title<span class="nt">&lt;/h5&gt;</span>
      ...
      <div class="row footer-top-29">
        ...
        <div class="col-lg-3 col-sm-6 footer-list-29 footer-2 mt-lg-0 mt-md-5 mt-4">
          ...
          <ul class="mt-3">
            ...
            <li><a href="https://p.w3layouts.com/cdn-cgi/l/email-protection#c0a5b8a1adb0aca580ada1a9aceea3afad" class="mail"><span class="fa fa-envelope-o"></span>
                <span class="__cf_email__" data-cfemail="b7d2cfd6dac7dbd2f7dad6dedb99d4d8da">[email&#160;protected]</span></a></li>
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'939135e31d3be5bf',t:'MTc0NjEyMjc2My4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='../../../../../../cdn-cgi/challenge-platform/h/b/scripts/jsd/a51d7b3d53cb/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
