...
--font-color: #777;
--bg-color: #fff;
--banner:linear-gradient(to right, rgb(8 1 60 / 80%), rgb(8 1 60 / 80%));
--heading-color: #111;
--border-radius: 6px;
...
--bg-color: #121212;
--heading-color: #eee;
--banner: linear-gradient(to right, rgb(14 14 14 / 80%), rgb(10 10 10 / 75%));
...
.navbar .search-right .search__icon {
position: absolute;
right: 20px;
font-size: 15px;
top: 15px;
...
background: var(--banner), url(../images/banner.jpg);
...
.w3l-banner-content span.video-play-icon {
display: inline-block;
width: 100px;
height: 100px;
font-size: 40px;
...
.w3l-banner-content span.video-play-icon:hover {
transform: scale(1.2);
transition: 0.3s ease-in-out;
background: var(--primary-color);
border: transparent;
...
.content4-right-icon:hover .content4-icon {
background-color: var(--primary-color);
transition: 0.3s ease-in-out;
}

.w3l-content-4 span.fa {
line-height: 70px;
color: var(--primary-color);
}

.content4-right-icon:hover span.fa {
color: #fff;
}
...
.blog-w3hny-right .sidebar-widget ul.blog-cat li a span.fa {
color: var(--primary-color);
font-size: inherit;
background: none;
/* font-size: 16px; */
...
.w3l-content-5 {
background-size: cover;
background-image: linear-gradient(to right, rgb(0 5 14 / 70%), rgb(1 6 16 / 70%)), url(../images/banner.jpg);
background-repeat: no-repeat, no-repeat, no-repeat;
background-position: center;
background-attachment: fixed;
}
...
background-size: cover;
background-image: linear-gradient(to right, rgb(0 5 14 / 70%), rgb(1 5 14 / 70%)), url(../images/banner2.jpg);
background-repeat: no-repeat, no-repeat, no-repeat;
background-position: center;
background-attachment: fixed;
min-height: 300px;
...
color: #FFFFFF;
font-size: 250px;
animation: filling 8s ease forwards;
font-weight: 700;
line-height: 250px;
}
...
.w3l-copyright .main-social-footer-29 a span.fa {
margin-left: 10px;
color: #fff;
display: inline-block;
text-align: center;
...
.w3l-copyright .main-social-footer-29 a span.fa:hover {
transition: 0.3s;
color: var(--primary-color);
}
